...
/*Todo 추가하기*/
export const __addTodos = createAsyncThunk("todos/addTodos", async (arg, thunkAPI) => {
  try {
...
export const __getTodo = createAsyncThunk("todos/getTodo", async (payload, thunkAPI) => {
  try {
